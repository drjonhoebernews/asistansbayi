...
export default function HeliumSidebar({ className }: { className?: string }) {
  ...
  return (
    <aside
      className={cn(
        'fixed bottom-0 start-0 z-50 h-full w-[284px] p-5 dark:bg-gray-100/50 2xl:w-[308px]',
        className
      )}
    >
      <div className="h-full rounded-2xl bg-gray-900 p-1.5  pl-0 pr-1.5 dark:bg-gray-100/70">

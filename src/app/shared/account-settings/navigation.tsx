...
export default function ProfileSettingsNav() {
  ...
  return (
    <div className="sticky top-[62px] z-20 -mx-4 -mt-4 border-b border-gray-200 bg-white px-4 py-0 font-medium text-gray-500 dark:bg-gray-50 sm:-mt-2 md:top-[78px] md:-mx-5 md:px-5 lg:-mx-8 lg:mt-0 lg:px-8 xl:-mx-6 xl:px-6 2xl:top-20 3xl:-mx-[33px] 3xl:px-[33px] 4xl:-mx-10 4xl:px-10">

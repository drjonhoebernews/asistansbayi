...
import {EditodalModalView} from "@/app/shared/policeoz/ozellikler/list/edit-modal";
  ...
  },
  {
    title: (
        <HeaderCell
            ...
            sortable
            ascending={
                sortConfig?.direction === 'asc' && sortConfig?.key === 'is_included'
            }
        />
    ),
    onHeaderCell: () => onHeaderCellClick('is_included'),
    dataIndex: 'is_included',
    key: 'is_included',
    width: 50,
    render: (is_included: StatusType) => {
      return (
          <div className="flex items-center gap-1.5">

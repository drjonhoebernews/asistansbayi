...
export const FormParts = {
  PaketBilgileri: 'PaketBilgileri',
  SatisBilgileri: 'SatisBilgileri',
  SatisAdres: 'SatisAdres',
  SatisCalismaSekli: 'SatisCalismaSekli',
  SatisYetkiGuvenlik: 'SatisYetkiGuvenlik',
  SatisEvraklari: 'SatisEvraklari',
};

export const menuItems = [
  {
    label: 'Paket Bilgileri',
    value: FormParts.PaketBilgileri,
  },
  {
    label: 'Kişi Bilgileri',
    value: FormParts.SatisBilgileri,
  },
  {
    label: 'İkametgah Bilgileri',
    value: FormParts.SatisAdres,
  },
  {
    label: 'Plaka Bilgileri',
    value: FormParts.SatisCalismaSekli,
  },
  {
    label: 'İkametgah Bilgileri',
    value: FormParts.SatisYetkiGuvenlik,
  },
];

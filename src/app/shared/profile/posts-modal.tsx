    ...
    <>
      <div className="flex justify-between">
        <div className="flex gap-4">
          ...
          />
          <div>
            <Text tag="h2" className="text-base text-gray-1000">
              Andrei Jackson
            </Text>
...
function ModalCardComment({ commentData }: CommentPropsType) {
  ...
  return (
    <div className="flex items-start gap-4 pr-3 pt-6">
      ...
      />
      <div>
        <Text tag="h2" className="text-sm font-medium text-gray-1000">
  ...
  return (
    <div className="relative mt-8">
      ...
      <Button
        variant="text"
        color="primary"
        className="absolute bottom-2 ltr:right-2 rtl:left-2"
      >
        Post
      </Button>
    </div>

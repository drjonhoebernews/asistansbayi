...
const initialData = [
  {
    ...
    product: {
      name: 'Prada Bag',
      image:
        'https://s3.amazonaws.com/redqteam.com/isomorphic-furyroad/public/products/1.webp',
    },
    price: '$175.00',
    quantity: 1,
  },
  ...
  },
  {
    ...
    product: {
      name: 'Pink Purse',
      image:
        'https://s3.amazonaws.com/redqteam.com/isomorphic-furyroad/public/products/4.webp',
    },
    price: '$24.00',
    quantity: 1,
  },
    ...
    render: (product: any) => (
      <div className="flex items-center">
        ...
        <div className="ms-4">
          ...
          <Text tag="p" className="!text-sm font-normal text-gray-500">
            {product.category}
          </Text>
        </div>
      </div>

...
export const FormParts = {
  AcenteBilgileri: 'AcenteBilgileri',
  AcenteAdres: 'AcenteAdres',
  AcenteCalismaSekli: 'AcenteCalismaSekli',
  AcenteYetkiGuvenlik: 'AcenteYetkiGuvenlik',
  AcenteEvraklari: 'AcenteEvraklari',
};

export const menuItems = [
  {
    label: 'Acente Bilgileri',
    value: FormParts.AcenteBilgileri,
  },
  {
    label: 'Acente Adres',
    value: FormParts.AcenteAdres,
  },
  {
    label: 'Acente Çalışma Şartları & Ödeme',
    value: FormParts.AcenteCalismaSekli,
  },
  {
    label: 'Acenta Yetki & Güvenlik',
    value: FormParts.AcenteYetkiGuvenlik,
  },
  {
    label: 'Acente Evrakları',
    value: FormParts.AcenteEvraklari,
  },
];

...
import FormSenderInfo from '@/app/shared/sigorta/bayi/create/form-sender-info';
import FormPackageInfo from '@/app/shared/sigorta/bayi/create/form-package-info';
import FormShippingInfo from '@/app/shared/sigorta/bayi/create/form-shipping-info';
import FormRecipientInfo from '@/app/shared/sigorta/bayi/create/form-recipient-info';
import FormPaymentMethodInfo from '@/app/shared/sigorta/bayi/create/form-payment-method-info';
import FormNav, {
  FormParts,
} from '@/app/shared/sigorta/bayi/create/form-nav';
import {
  acenteFormSchema,
  defaultValues,
  ShipmentFormTypes,
} from '@/app/shared/sigorta/bayi/create/form-utils';
...
export default function CreateShipment({
  ...
  const [shipmentData, setShipmentData] = useState<ShipmentFormTypes | null>(null);

  const methods = useForm({
    defaultValues: defaultValues(shipmentData || shipment),
    ...
    <div className="@container">
      ...
      <FormProvider {...methods}>
        ...
        >
          ...
          <FormFooter
            isLoading={isLoading}
            submitBtnText={id ? 'Güncelle' : 'Acente Oluştur'}
          />
        </form>
      </FormProvider>
    </div>
